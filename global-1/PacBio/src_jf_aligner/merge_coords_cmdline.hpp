...
#ifndef __MERGE_COORDS_CMDLINE_HPP__
#define __MERGE_COORDS_CMDLINE_HPP__
...
public:
  ...
  bool                           output_given;
  ::std::vector<const char *>    coords_arg;
  typedef ::std::vector<const char *>::iterator coords_arg_it;
  typedef ::std::vector<const char *>::const_iterator coords_arg_const_it;
  ...
  merge_coords_cmdline(int argc, char* argv[]) :
    output_arg(""), output_given(false),
    coords_arg()
  { parse(argc, argv); }
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUo:";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    ...
    for( ; optind < argc; ++optind) {
      coords_arg.push_back(argv[optind]);
    }
  }
  static const char * usage() { return "Usage: merge_coords_cmdline [options] coords:PATH+"; }
  class error {
    int code_;
  ...
  static const char * help() { return
    "Merge coords file generated by jf_aligner\n\nMerge coords file. It is expected that the order of the\n" \
    "query sequences is identical in all input files and all query\n" \
    "sequences are present, even if no match is reported. This requires\n" \
    "switches --compact and --zero-match to jf_aligner.\n\n"
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void dump(::std::ostream &os = std::cout) {
    ...
    os << "coords_arg:" << vec_str(coords_arg) << "\n";
  }
};
#endif // __MERGE_COORDS_CMDLINE_HPP__"
