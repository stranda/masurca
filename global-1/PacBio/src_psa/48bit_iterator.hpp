...
// Parallel safe by default. Nothing to do
template<typename I>
struct parallel_iterator_traits<fortyeight_iterator<I>> {
  typedef fortyeight_iterator<I> type;
};
template<typename I>
struct parallel_iterator_traits<const_fortyeight_iterator<I>> {
  typedef const_fortyeight_iterator<I> type;
};
} // namespace compactsufsort_imp
