...
public:
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUm:n:v:t:o:q:c:l:g";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    while(true) {
      ...
      case 'v':
        val_given = true;
        val_arg = conv_int<int>((const char*)optarg, err, false);
        CHECK_ERR(int_t, optarg, "-v, --val=int")
        break;
      case 't':
        threads_given = true;
  ...
  static const char * help() { return
    ...
    " -v, --val=int                            Value field length in hash (7)\n"
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void dump(::std::ostream &os = std::cout) {
    ...
    os << "val_given:" << val_given << " val_arg:" << val_arg << "\n";
