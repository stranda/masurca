...
#ifndef __FILTER_OVERLAP_FILE_CMDLINE_HPP__
#define __FILTER_OVERLAP_FILE_CMDLINE_HPP__
...
class filter_overlap_file_cmdline {
...
public:
  ...
  bool                           output_given;
  bool                           dump_flag;
  const char *                   fragments_arg;
  const char *                   kmer_arg;
  const char *                   overlaps_arg;
  ...
  filter_overlap_file_cmdline(int argc, char* argv[]) :
    threads_arg((int)1), threads_given(false),
    output_arg("/dev/fd/1"), output_given(false),
    dump_flag(false),
    fragments_arg(""),
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUt:o:";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    ...
    fragments_arg = argv[optind];
    ++optind;
    kmer_arg = argv[optind];
    ++optind;
    overlaps_arg = argv[optind];
    ++optind;
  }
  static const char * usage() { return "Usage: filter_overlap_file_cmdline [options] fragments:path kmer:path overlaps:path"; }
  class error {
    int code_;
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void dump(::std::ostream &os = std::cout) {
    ...
    os << "dump_flag:" << dump_flag << "\n";
    os << "fragments_arg:" << fragments_arg << "\n";
    os << "kmer_arg:" << kmer_arg << "\n";
    os << "overlaps_arg:" << overlaps_arg << "\n";
  }
};
#endif // __FILTER_OVERLAP_FILE_CMDLINE_HPP__"
