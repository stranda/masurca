...
public:
  string                         output_arg;
  bool                           output_given;
  string                         base_quality_arg;
  bool                           base_quality_given;
  string                         library_arg;
  string                         path1_arg;
  string                         path2_arg;
  ...
  args_t() :
    ...
    base_quality_arg("#"), base_quality_given(false),
    library_arg(""),
    path1_arg(""),
    path2_arg("")
  { }
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUo:q:";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    while(true) {
      ...
      case 'o':
        ...
        break;
      case 'q':
        base_quality_given = true;
        base_quality_arg.assign(optarg);
        break;
      }
    }
    ...
    library_arg = string(argv[optind]);
    ++optind;
    path1_arg = string(argv[optind]);
    ++optind;
    path2_arg = string(argv[optind]);
    ++optind;
  }
  static const char * usage() { return "Usage: args_t [options] library:string path1:string path2:string"; }
  class error {
    int code_;
  ...
  static const char * help() { return
    "Rename and filter input fastq file\n\n\n\n"
    "Options (default value in (), *required):\n"
    " -o, --output=string                      Output file (stdout)\n"
    " -q, --base-quality=string                Lowest valide quality score (#)\n"
    " -U, --usage                              Usage\n"
    " -h, --help                               This message\n"
    " -V, --version                            Version";
  }
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void dump(::std::ostream &os = std::cout) {
    ...
    os << "base_quality_given:" << base_quality_given << " base_quality_arg:" << base_quality_arg << "\n";
    os << "library_arg:" << library_arg << "\n";
    os << "path1_arg:" << path1_arg << "\n";
    os << "path2_arg:" << path2_arg << "\n";
  }
};
