...
public:
  ...
  cmdline_parse() :
    ...
    fib_flag(false),
    bloom_flag(false),
    number_reads_arg((uint64_t)1000000), number_reads_given(false)
  { }
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUi:o:n:";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    while(true) {
      ...
      case 'n':
        ...
        number_reads_arg = conv_uint<uint64_t>((const char*)optarg, err, false);
