...
public:
  ...
  cmdline_parse() :
    min_overlap_length_arg(0), min_overlap_length_given(false),
    ...
    max_nodes_allowed_arg((int)4000), max_nodes_allowed_given(false),
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUm:u:v:o:t:";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    while(true) {
      ...
      case MIN_OVERLAP_LENGTH_OPT:
        ...
        min_overlap_length_arg = conv_int<int>((const char*)optarg, err, false);
      ...
      case MAX_NODES_ALLOWED_OPT:
        ...
        max_nodes_allowed_arg = conv_int<int>((const char*)optarg, err, false);
  ...
  static const char * usage() { return "Usage: cmdline_parse [options] input-file:string"; }
  class error {
    int code_;
  ...
  static const char * help() { return
    ...
    "     --join-aggressive=int                Report a join even if it is not unique. (0)\n"
