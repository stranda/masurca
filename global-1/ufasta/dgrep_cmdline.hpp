...
#ifndef __DGREP_CMDLINE_HPP__
#define __DGREP_CMDLINE_HPP__
...
public:
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUm:nv";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    ...
    regexp_arg = argv[optind];
    ++optind;
    for( ; optind < argc; ++optind) {
      file_arg.push_back(argv[optind]);
    }
  }
  static const char * usage() { return "Usage: dgrep_cmdline [options] regexp:string file:string+"; }
  class error {
    int code_;
  ...
  static const char * help() { return
    "Match the data and output the header and matching lines\n\n"
    "Options (default value in (), *required):\n"
    " -m, --max-count=NUM                      Stop reading after NUM matching headers\n"
    " -n, --line-number                         Prefix each line of output with the 1-based line number within its input file (false)\n"
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void dump(::std::ostream &os = std::cout) {
    ...
    os << "line_number_flag:" << line_number_flag << "\n";
    os << "invert_match_flag:" << invert_match_flag << "\n";
    os << "regexp_arg:" << regexp_arg << "\n";
    os << "file_arg:" << vec_str(file_arg) << "\n";
  }
};
#endif // __DGREP_CMDLINE_HPP__"
