...
#ifndef __FORMAT_CMDLINE_HPP__
#define __FORMAT_CMDLINE_HPP__
...
public:
  uint32_t                       line_length_arg;
  bool                           line_length_given;
  bool                           lower_case_flag;
  bool                           upper_case_flag;
  bool                           spaces_flag;
  bool                           header_flag;
  ...
  format_cmdline() :
    line_length_arg((uint32_t)70), line_length_given(false),
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVl:LUsH";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    while(true) {
      ...
      case '?':
        ...
        exit(1);
      case 'l':
        line_length_given = true;
        line_length_arg = conv_uint<uint32_t>((const char*)optarg, err, false);
        CHECK_ERR(uint32_t, optarg, "-l, --line-length=L")
        break;
      case 'L':
    ...
    if(upper_case_flag && lower_case_flag)
      error("Switches [-U, --upper-case] and [-L, --lower-case] are mutually exclusive");
  ...
  static const char * usage() { return "Usage: format_cmdline [options] file:string+"; }
  class error {
    int code_;
  ...
  static const char * help() { return
    ...
    " -l, --line-length=L                      Wrap length to L characters (70)\n"
    " -L, --lower-case                         Change all bases to lower case (false)\n"
    " -U, --upper-case                         Change all bases to upper case (false)\n"
    " -s, --spaces                             Remove white spaces (false)\n"
    " -H, --header                             Shorten header to first word after > (false)\n"
    "     --usage                              Usage\n"
    " -h, --help                               This message\n"
    " -V, --version                            Version";
  }
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void dump(::std::ostream &os = std::cout) {
    os << "line_length_given:" << line_length_given << " line_length_arg:" << line_length_arg << "\n";
    os << "lower_case_flag:" << lower_case_flag << "\n";
    os << "upper_case_flag:" << upper_case_flag << "\n";
    os << "spaces_flag:" << spaces_flag << "\n";
    os << "header_flag:" << header_flag << "\n";
    os << "file_arg:" << vec_str(file_arg) << "\n";
  }
};
#endif // __FORMAT_CMDLINE_HPP__"
