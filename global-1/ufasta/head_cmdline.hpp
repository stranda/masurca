...
#ifndef __HEAD_CMDLINE_HPP__
#define __HEAD_CMDLINE_HPP__
...
public:
  ...
  head_cmdline() :
    entries_arg((int64_t)10), entries_given(false),
    bytes_arg(0), bytes_given(false),
    quiet_flag(false),
    verbose_flag(false),
    file_arg()
  { }
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUn:c:qv";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    while(true) {
      ...
      case 'n':
        entries_given = true;
        entries_arg = conv_int<int64_t>((const char*)optarg, err, true);
        CHECK_ERR(int64_t, optarg, "-n, --entries=[-]K")
        break;
      case 'c':
        bytes_given = true;
        bytes_arg = conv_uint<uint64_t>((const char*)optarg, err, true);
        CHECK_ERR(uint64_t, optarg, "-c, --bytes=K")
        break;
      case 'q':
        quiet_flag = true;
        break;
    ...
    if(bytes_given && entries_given)
      error("Switches [-c, --bytes=K] and [-n, --entries=[-]K] are mutually exclusive");
  ...
  static const char * usage() { return "Usage: head_cmdline [options] file:string+"; }
  class error {
    int code_;
  ...
  static const char * help() { return
    "Output the head of fasta files\n\n"
    "Options (default value in (), *required):\n"
    " -n, --entries=[-]K                       Print the first K entries. With a leading -, print all but the last K entries. (10)\n"
    " -c, --bytes=K                            Print up to the entry containing byte K in file\n"
    " -q, --quiet                              Never print headers giving file names (false)\n"
    " -v, --verbose                            Always print headers giving file names (false)\n"
    " -U, --usage                              Usage\n"
    " -h, --help                               This message\n"
    " -V, --version                            Version";
  }
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void dump(::std::ostream &os = std::cout) {
    os << "entries_given:" << entries_given << " entries_arg:" << entries_arg << "\n";
    os << "bytes_given:" << bytes_given << " bytes_arg:" << bytes_arg << "\n";
    os << "quiet_flag:" << quiet_flag << "\n";
    os << "verbose_flag:" << verbose_flag << "\n";
    os << "file_arg:" << vec_str(file_arg) << "\n";
  }
};
#endif // __HEAD_CMDLINE_HPP__"
