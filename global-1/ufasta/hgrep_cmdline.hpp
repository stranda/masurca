...
#ifndef __HGREP_CMDLINE_HPP__
#define __HGREP_CMDLINE_HPP__
...
public:
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUm:v";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
  ...
  static const char * usage() { return "Usage: hgrep_cmdline [options] regexp:string file:string+"; }
  class error {
    int code_;
