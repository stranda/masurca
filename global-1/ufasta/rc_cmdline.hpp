...
#ifndef __RC_CMDLINE_HPP__
#define __RC_CMDLINE_HPP__
...
public:
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUC";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
  ...
  static const char * usage() { return "Usage: rc_cmdline [options] file:string+"; }
  class error {
    int code_;
  ...
  static const char * help() { return
    "Reverse complement all reads in file\n\n"
    "Options (default value in (), *required):\n"
    " -C, --canonical                          Output canonical sequences (false)\n"
    " -U, --usage                              Usage\n"
    " -h, --help                               This message\n"
    " -V, --version                            Version";
  }
