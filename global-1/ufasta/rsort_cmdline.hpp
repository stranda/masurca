...
#ifndef __RSORT_CMDLINE_HPP__
#define __RSORT_CMDLINE_HPP__
...
public:
  ...
  rsort_cmdline() :
    start_arg((int64_t)0), start_given(false),
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUs:k:p";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    while(true) {
      ...
      case 's':
        start_given = true;
        start_arg = conv_int<int64_t>((const char*)optarg, err, false);
        CHECK_ERR(int64_t, optarg, "-s, --start=int64")
        break;
      case 'k':
        key_given = true;
  ...
  static const char * usage() { return "Usage: rsort_cmdline [options] file:path+"; }
  class error {
    int code_;
  ...
  static const char * help() { return
    "Sort a fasta file in a streaming fashion\n\n\n\n"
    "Options (default value in (), *required):\n"
    " -s, --start=int64                        Starting value (0)\n"
    " -k, --key=uint32                         1-index of column in header to sort by (1)\n"
    " -p, --prefix                             Skip prefix of key until first number (false)\n"
    " -U, --usage                              Usage\n"
    " -h, --help                               This message\n"
    " -V, --version                            Version";
  }
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void dump(::std::ostream &os = std::cout) {
    ...
    os << "prefix_flag:" << prefix_flag << "\n";
    os << "file_arg:" << vec_str(file_arg) << "\n";
  }
};
#endif // __RSORT_CMDLINE_HPP__"
