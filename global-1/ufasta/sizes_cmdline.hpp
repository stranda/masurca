...
#ifndef __SIZES_CMDLINE_HPP__
#define __SIZES_CMDLINE_HPP__
...
public:
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUHiqv";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
  ...
  static const char * usage() { return "Usage: sizes_cmdline [options] file:string+"; }
  class error {
    int code_;
  ...
  static const char * help() { return
    "Display the sizes of the sequences in fasta file\n\n"
    "Options (default value in (), *required):\n"
    " -H, --header                             Print headers before size (false)\n"
    " -i, --index                              Print in addition starting offset of each sequence (false)\n"
