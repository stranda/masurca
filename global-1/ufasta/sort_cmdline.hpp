...
public:
  ...
  uint32_t                       key_arg;
  bool                           key_given;
  const char *                   write_seed_arg;
  bool                           write_seed_given;
  const char *                   read_seed_arg;
  bool                           read_seed_given;
  ...
  sort_cmdline() :
    ...
    write_seed_arg(""), write_seed_given(false),
    read_seed_arg(""), read_seed_given(false),
    file_arg()
  { }
  ...
  void parse(int argc, char* argv[]) {
    static struct option long_options[] = {
      ...
      {"header-full", 0, 0, 'H'},
      {"key", 1, 0, 'k'},
      {"write-seed", 1, 0, WRITE_SEED_OPT},
      {"read-seed", 1, 0, READ_SEED_OPT},
      {"help", 0, 0, 'h'},
      {"usage", 0, 0, 'U'},
      {"version", 0, 0, 'V'},
      {0, 0, 0, 0}
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    while(true) {
      ...
      case 'k':
        ...
        break;
      case WRITE_SEED_OPT:
        write_seed_given = true;
        write_seed_arg = optarg;
        break;
      case READ_SEED_OPT:
        read_seed_given = true;
        read_seed_arg = optarg;
        break;
      }
    }
  ...
  static const char * help() { return
    ...
    "     --write-seed=PATH                    Write seed used by random order to PATH\n"
    "     --read-seed=PATH                     Read seed for random order from PATH\n"
    " -U, --usage                              Usage\n"
    " -h, --help                               This message\n"
    " -V, --version                            Version";
  }
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void dump(::std::ostream &os = std::cout) {
    ...
    os << "write_seed_given:" << write_seed_given << " write_seed_arg:" << write_seed_arg << "\n";
    os << "read_seed_given:" << read_seed_given << " read_seed_arg:" << read_seed_arg << "\n";
