...
#ifndef __SPLIT_CMDLINE_HPP__
#define __SPLIT_CMDLINE_HPP__
...
public:
  ...
  typedef ::std::vector<const char *>::iterator output_arg_it;
  typedef ::std::vector<const char *>::const_iterator output_arg_const_it;
  ...
  split_cmdline() :
    input_arg("/dev/stdin"), input_given(false),
    output_arg()
  { }
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUi:";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    ...
    for( ; optind < argc; ++optind) {
      output_arg.push_back(argv[optind]);
    }
  }
  static const char * usage() { return "Usage: split_cmdline [options] output:PATH+"; }
  class error {
    int code_;
  ...
  static const char * help() { return
    "Split an input fasta file into many different files\n\n"
    "Options (default value in (), *required):\n"
    " -i, --input=PATH                         Input fasta file (/dev/stdin)\n"
    " -U, --usage                              Usage\n"
    " -h, --help                               This message\n"
    " -V, --version                            Version";
  }
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void dump(::std::ostream &os = std::cout) {
    ...
    os << "output_arg:" << vec_str(output_arg) << "\n";
  }
};
#endif // __SPLIT_CMDLINE_HPP__"
