...
#ifndef __TAIL_CMDLINE_HPP__
#define __TAIL_CMDLINE_HPP__
...
public:
  ...
  tail_cmdline() :
    entries_arg("10"), entries_given(false),
    bytes_arg(""), bytes_given(false),
    quiet_flag(false),
    verbose_flag(false),
    file_arg()
  { }
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    while(true) {
      ...
      case 'n':
        entries_given = true;
        entries_arg.assign(optarg);
        break;
      case 'c':
        bytes_given = true;
        bytes_arg.assign(optarg);
        break;
      case 'q':
        quiet_flag = true;
        break;
  ...
  static const char * usage() { return "Usage: tail_cmdline [options] file:string+"; }
  class error {
    int code_;
  ...
  static const char * help() { return
    "Output the tail of fasta files\n\n"
    "Options (default value in (), *required):\n"
    " -n, --entries=[+]K                       Print the last K entries. With a leading +, print all but the first K entries. (10)\n"
    " -c, --bytes=+K                           With a leading +, print entries starting at or after byte K\n"
